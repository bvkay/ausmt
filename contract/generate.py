...
BANNER = "GENERATED by contract/generate.py from contract/columns.json + licenses.json — DO NOT EDIT."
...
def main(argv):
    ...
    cat, sci, tf = _load()
    lic = _load_lic()
    py, js = _py(cat, sci, tf, lic), _js(cat, sci, tf, lic)
    if mode == "check":
        ...
        if stale:
            ...
            return 1
        print("contract: _contract.py and contract.js are in sync with columns.json")
        return 0
