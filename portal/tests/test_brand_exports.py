...
def test_the_cards_corner_mark_is_a_generated_export_the_gate_holds():
    ...
    It exists at all because the 1024 px mark is a third of a megabyte to show at 42 px, which the
    engine image would otherwise have to carry. The export size is a whole multiple of the drawn height,
