"""The identifiers design - the related-identifiers model): drawer render pins.
...
code+="\nglobalThis.__api={boot,hydrationDone:()=>HYDRATION_DONE,openStation,openSurvey,surveyCard,nST:()=>ST.length,firstSurvey:()=>surveys[0]};";
