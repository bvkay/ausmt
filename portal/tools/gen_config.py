...
def build_config(cfg):
    ...
    return {
        ...
        "basemap": {"provider": b.get("provider", "carto") or "carto",
                    ...
                    "pmtiles_world": b.get("pmtiles_world", "/basemap/world.pmtiles") or "/basemap/world.pmtiles",
                    "pmtiles_region": b.get("pmtiles_region", "/basemap/region.pmtiles") or "/basemap/region.pmtiles"},
...
def render(conf):
    ...
    return ("// AUTO-GENERATED from portal.config.yaml by tools/gen_config.py: edit the YAML and\n"
            "// regenerate this file, never edit it by hand. It is the browser-side reflection of\n"
            "// the portal configuration (branding, version, analytics). See docs: portal internals, config.js.\n"
