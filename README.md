...
Built with the Australian MT community, it is a national catalogue
of magnetotelluric transfer functions, carrying the provenance, licence and citation details of
each one. 

This is an offline build engine, a static portal, and a curated submission gateway. 
Survey packages (EDI + `survey.yaml`) are validated, parsed with the community mt_metadata/mth5 
toolchain, and served as a browsable, citable catalogue. Development happens at `bvkay/ausmt`;
